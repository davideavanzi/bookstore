  ...
  return knex('book').del()
    .then(function () {
      ...
      return knex('book').insert([
        ...
        abstract: "Celebrating the work of Jean-Michel Basquiat, this volume features reproductions of his work, including rarely-seen pieces from private collections. It offers new perspectives on Basquiat's achievements, exploring them in the contexts of his key influences, and explores many individual works in detail.",
        fact_sheet: "New York City graffiti artist turned art world sensation, Jean-Michel Basquiat was a self-taught African American painter who died in 1988 of a drug overdose at the age of 27. In the ten years before his death, he showed at prestigious galleries in the United States and Europe and painted collaborative works with Andy Warhol and Francesco Clemente. This Italian catalog accompanies a Basquiat exhibition in Trieste and features fine reproductions of major Basquiat paintings, along with portrait photographs of the artist, a chronology of his life, and essays and interviews in both Italian and English translation. It provides a good overview of Basquiat's life and work, though the translation is sometimes quirky and the text concentrates more on Basquiat's activities in Europe than does Richard Marchall's Jean-Michel Basquiat (Abrams, 1995). As evidenced by the film and written accounts of Basquiat's life that ",
        genre_id: 21,
        value: 150,
        stock: 3},
        {
        ...
        abstract: "A Jedi must be a fearless warrior, a guardian of justice, and a scholar in the ways of the Force. But perhaps a Jedi’s most essential duty is to pass on what they have learned. Master Yoda trained Dooku; Dooku trained Qui-Gon Jinn; and now Qui-Gon has a Padawan of his own. But while Qui-Gon has faced all manner of threats and danger as a Jedi, nothing has ever scared him like the thought of failing his apprentice.",
        fact_sheet: "Obi-Wan Kenobi has deep respect for his Master, but struggles to understand him. Why must Qui-Gon so often disregard the laws that bind the Jedi? Why is Qui-Gon drawn to ancient Jedi prophecies instead of more practical concerns? And why wasn’t Obi-Wan told that Qui-Gon is considering an invitation to join the Jedi Council—knowing it would mean the end of their partnership? The simple answer scares him: Obi-Wan has failed his Master.",
        genre_id: 10,
        value: 16,
        stock: 30},
        {
