...
- **Deliverable D2**: 
  ...
  API can be found at [this address](https://hyp.avanzi.com/backend/api-docs).
  - an exact copy of the YAML file used to initiate the swagger middleware can be found at [this address](https://hyp.avanzi.com/backend/swagger.yaml).
...
- **Deliverable D5**: the address of the online source control repository is
  ...
  instructors.
- **Installation notes** and other informations can be found at [this address](https://hyp.avanzi.dev/backend/README.md).
## Specifications
### Web Architecture
